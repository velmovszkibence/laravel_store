@if ($paginator->hasPages())
    <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
        <div class="flex justify-evenly md:justify-between flex-1 md:hidden">
        ...
        <div class="hidden md:flex-1 md:flex md:items-center md:justify-evenly">
            <div>
