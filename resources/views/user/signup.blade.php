    ...
    <div class="px-5 mt-24 mx-auto md:px-20 md:mt-20 md:pt-10 md:pr-16">
        ...
        <form action="{{ route('user.signup') }}" method="post" class="w-full max-w-sm mx-auto">
            ...
            <div class="agreement text-center py-5 sm:pl-5">
                <span class="text-sm text-gray-600">By creating an account, you agree to <a href="#" class="text-gray-700 underline">Privacy Policy</a> and <a href="#" class="text-gray-700 underline">Terms of use</a></span>
            </div>
