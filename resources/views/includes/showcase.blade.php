        ...
        <div class="flex flex-col md:flex-row">
            <div class="showcase-text flex-auto">
                ...
                <div class="flex flex-col md:flex-row text-sm py-8 justify-between">
                    ...
                    <a href="{{ route('user.signin') }}" class="button bg-orange hover:bg-white hover:text-orange rounded-full border border-white shadow-sm px-6 py-1">
                        Sign In
                    </a>
                    </div>
                </div>
            </div>
            <div class="showcase-image flex-auto">
                <img src="../images/mens_shirt.png" alt="mens_shirt"
                class="img-fluid h-64 mx-auto">
            </div>
